        ...
        <p className="text-xl sm:text-xl md:text-xl lg:text-4xl mb-4 italic font-extrabold text-white tracking-wide leading-relaxed font-serif max-w-3xl">
         ...
         <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
          <span className="relative group  ">
            <Link to="/signup" className="bg-white flex gap-4 items-center   hover:bg-blue-500 text-uniport-blue pl-8 pr-4 py-2 sm:py-1 rounded-full font-bold lg:text-xl transition-colors shadow-lg sm:text-sm ">
              APPLY NOW 
          ...
          <Link to="/about" className="bg-transparent border border-white text-white px-8 py-2 rounded-full font-bold  lg:text-xl sm:py-1 hover:bg-white/10 transition-colors">
            Learn More
          </Link>
