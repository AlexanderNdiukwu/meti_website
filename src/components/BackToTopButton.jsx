  ...
  return (
    <>
      {isVisible && (
        ...
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 px-2 block lg:hidden  left-8   z-50 flex items-center justify-center rounded-full bg-blue-900 text-white shadow-lg transition-all duration-300 hover:bg-gray-800 hover:scale-110 active:scale-95"
