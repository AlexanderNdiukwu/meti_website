      ...
      <p className='py-2 mt-4'> <span className='font-bold '>MOTTO:</span> Driving Sustainable Development Through Innovation</p>
        ...
        <div>
          ...
          <ul className=" text-gray-400">
            ...
            <li className='lg:mt-4 mt-3 '> Room 320-323 , 2nd Floor ETF Gas Engineering Building, Faculty of Engineering, Abuja Park Campus,University of Port Harcourt, Rivers State, Nigeria
